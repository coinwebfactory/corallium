...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Corallium address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for CORALLIUM"));
    ...
    */
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Corallium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Corallium addresses"));
